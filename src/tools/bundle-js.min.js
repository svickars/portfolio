  ...
  d3.selectAll(".pass-container").select("input").on("keydown", function () {
    ...
    if (d3.event.keyCode == 13) {
      if (d3.select(this).node().value == id) {
        var newHeight = d3.select(this.parentNode.parentNode.parentNode.parentNode).select(".inner").node().offsetHeight + 37;
        d3.select(this.parentNode.parentNode.parentNode.parentNode).classed("expanded", true).select(".inner-wrapper").style("height", "".concat(newHeight, "px"));
        d3.select(this.parentNode).classed("is-visible", false);
        d3.select(this.parentNode.parentNode).select("h2").classed("is-bg", false);
        d3.selectAll(".project").classed("is-bg", function () {
          return !d3.select(this).classed("expanded");
        });
